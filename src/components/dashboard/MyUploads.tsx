        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{uploads.filter(u => u.status === 'Completed').length}</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{uploads.filter(u => u.status === 'Processing').length}</p>
